...
var map = {
	"./product_controller.js": "./app/javascript/controllers/product_controller.js",
	"./product_upload_controller.js": "./app/javascript/controllers/product_upload_controller.js"
};
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    key: "handleManufacturerSelectChange",
    value: function handleManufacturerSelectChange() {
      this.getModelsData();
    }
  }, {
    key: "getModelsData",
    value: function getModelsData() {
      var _this = this;
      ...
      _rails_ujs__WEBPACK_IMPORTED_MODULE_1___default.a.ajax({
        type: "GET",
        url: "/models.json",
        data: "manufacturer=".concat(manufacturer),
        success: function success(data) {
          _this.updateSelectModelOptions(data);
        }
      });
    }
  }, {
    key: "updateSelectModelOptions",
    value: function updateSelectModelOptions(data) {
      var _this2 = this;
      ...
      data.forEach(function (modelName) {
        ...
        _this2.model.appendChild(option);
      });
    }
  }, {
    key: "createPromptToSelectModel",
    value: function createPromptToSelectModel() {
      var option = document.createElement("option");
      option.value = "";
...
_default.targets = ["manufacturer", "model", "carrierPlanType"];


/***/ }),

/***/ "./app/javascript/controllers/product_upload_controller.js":
/*!*****************************************************************!*\
  !*** ./app/javascript/controllers/product_upload_controller.js ***!
  \*****************************************************************/
/*! exports provided: default */
...
_default.targets = ["filename", "fileInput", "uploadButton"];
...
/******/ });
//# sourceMappingURL=application-d4a558d9e2088064a1f4.js.map